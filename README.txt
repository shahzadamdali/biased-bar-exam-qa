...
evaluate_results10.py (calculate and create tables, figures and graphs)
evaluate_results11.py (mixed effects output tables and graphs)
...
update_results4.py (combine all thresholds into one .tsv file)
update_results5.py (edit/update model names)
...
combined_results.tsv (combines all the thresholds into one large tsv file)